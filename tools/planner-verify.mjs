...
const OWNED_UPSTREAM_FILES = {
  ...
  'src/components/grid/Grid.jsx':
    'SVAR-M6 — reserves the RESOLVED annotation-lane height as a blank spacer under the grid header, and shifts the grid body by the same amount, so grid and chart rows share one y',
